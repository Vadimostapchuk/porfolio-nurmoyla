...
define('EMAIL_SETTINGS', [
  'addresses' => ['vadim.ostapchuk.02@bk.ru'], // кому необходимо отправить письмо
  'from' => ['ostv05@mail.ru', 'Имя сайта'], // от какого email и имени необходимо отправить письмо
  'subject' => 'Сообщение с формы обратной связи', // тема письма
  'host' => 'ssl://smtp.mail.ru', // SMTP-хост
  'username' => 'ostv05@mail.ru', // // SMTP-пользователь
  'password' => 'Rd14rcntg', // SMTP-пароль
  'port' => '465' // SMTP-порт
]);
